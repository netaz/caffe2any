...
I created this file by manually merging https://github.com/BVLC/caffe/blob/master/python/caffe/draw.py
and https://github.com/BVLC/caffe/blob/master/python/draw_net.py.
I wanted to be able to draw Caffe network graphs, without installing Caffe.
I needed to install pydot (instructions: http://www.installion.co.uk/ubuntu/precise/universe/p/python-pydot/install/index.html)
